    ...
    return (
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#about">À propos</a></li>
	         <li><a className="smoothscroll" href="#resume">Résume</a></li>
            <li><a className="smoothscroll" href="#portfolio">Démo</a></li>
      ...
      <div className="row banner">
         <div className="banner-text">
            ...
            <h3>Je suis actuellement <span>{description}</span> actuellement employé par <span>{occupation}</span> où je <span>{jobDescription}</span>.</h3>
            <hr />
            <ul className="social">
               {networks}
            </ul>
